...
function Inicio() {
  return (
    <div className="container" style={{ textAlign: 'center', backgroundImage: `url(/img/FondoInicio.png)`, height: '140vh', backgroundSize: 'cover', }}>
      ...
      <section className="tm-section-3 tm-section-mb" id="tm-section-3">
        ...
        <img src="../img/react.png" className="img-responsive tm-media-img" width={600}></img>
        <img src="../img/phaser.jpg" className="img-responsive tm-media-img" width={480} ></img>
      </section>
